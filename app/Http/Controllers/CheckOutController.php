...
class CheckOutController extends Controller
{
   public function CheckOutSave(Request $Request){
     ...
     $shipping->user_id =Session::get('userId'); 
     ...
     $shipping->address =$Request->address; 
          ...
          if ($shipping->save()) {
             ...
             if ($Request->payment=='Paypal') {
              ...
              $payment->user_id = Session::get('userId');
              $payment->payment = 'paypal';
              $payment->transaction = $Request->transaction;
              $payment->save();
               
             }elseif($Request->payment=='Delivary'){
            ...
            \Stripe\Charge::create([
              ...
              $payment->save();
          	 ...
          	 foreach ($order_detail as $cart) {
          	 	...
          	 	$order_de->user_id =Session::get('userId');
